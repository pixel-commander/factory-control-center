...
import type { ContactsListProps } from './ContactsList.types'

/**
 * questions to ask:
 * 1. what type of grid layout
 * 2. does this contacts-list loop through data? if so, what is the item_class
 * 3. is there a container_class for this contacts-list?
 **/
...
export const ContactsList = (props: ContactsListProps) => {
  ...
  const [rows] = useApi<RenderItemProps[]>('/api/contacts')
