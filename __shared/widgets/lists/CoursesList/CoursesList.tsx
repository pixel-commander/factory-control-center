...
import type { CoursesListProps } from './CoursesList.types'

/**
 * questions to ask:
 * 1. what type of grid layout
 * 2. does this courses-list loop through data? if so, what is the item_class
 * 3. is there a container_class for this courses-list?
 **/
...
export const CoursesList = (props: CoursesListProps) => {
  ...
  const [rows] = useApi<RenderItemProps[]>('/api/course')
