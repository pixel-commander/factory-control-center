...
import type { TodosListProps } from './TodosList.types'

/**
 * questions to ask:
 * 1. what type of grid layout
 * 2. does this todos-list loop through data? if so, what is the item_class
 * 3. is there a container_class for this todos-list?
 **/
...
export const TodosList = (props: TodosListProps) => {
  ...
  const [rows] = useApi<RenderItemProps[]>('/api/todo')
