import './css/assignments-list.css'
...
import type { AssignmentsListProps } from './AssignmentsList.types'

/**
 * questions to ask:
 * 1. what type of grid layout
 * 2. does this assignments-list loop through data? if so, what is the item_class
 * 3. is there a container_class for this assignments-list?
 **/
...
export const AssignmentsList = (props: AssignmentsListProps) => {
  ...
  const [rows] = useApi<RenderItemProps[]>('/api/assignment')
