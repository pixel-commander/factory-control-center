import './css/appointments-list.css'
...
import type { AppointmentsListProps } from './AppointmentsList.types'

/**
 * questions to ask:
 * 1. what type of grid layout
 * 2. does this appointments-list loop through data? if so, what is the item_class
 * 3. is there a container_class for this appointments-list?
 **/

export const AppointmentsList = (props: AppointmentsListProps) => {
  const {
  ...
  const [rows] = useApi<RenderItemProps[]>('/api/appointments')
