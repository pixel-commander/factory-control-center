import './css/appointment-item.css'
import type { RenderItemProps } from '../../../components/RenderItems/RenderItems.types'

export const AppointmentElement = (props?: RenderItemProps) => {
  const { name, title, label, location } = props || {}
  ...
  return (
    <div className='appointment-item'>
      ...
      {location ? <div className='mark'>{String(location)}</div> : null}
